...
maksimal = max(var_list)  # Mencari nilai maksimum dalam list
minimal = min(var_list)  # Mencari nilai minimum dalam list
banyak = var_list.count(605132)  # Menghitung berapa kali angka 605132 muncul
